...
const Footer = () => {
  return (
    <footer className="  border-blue-800 border-t-2 border-solid  text-center dark:bg-neutral-600 dark:text-neutral-200 lg:text-left bg-slate-100" >
        ...
        <div className="mx-6 py-4 md:py-16 text-center md:text-left ">
          <div className="grid-1 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <p className="mb-4  mr-4 flex items-center lg:text-justify w-80 justify-center md:justify-start">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  fill="currentColor"
